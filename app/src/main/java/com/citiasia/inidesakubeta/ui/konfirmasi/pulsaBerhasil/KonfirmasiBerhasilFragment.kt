...
class KonfirmasiBerhasilFragment : Fragment() {

    private var _binding: FragmentKonfirmasiBerhasilBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentKonfirmasiBerhasilBinding.inflate(layoutInflater, container, false)
        return binding.root
    }
