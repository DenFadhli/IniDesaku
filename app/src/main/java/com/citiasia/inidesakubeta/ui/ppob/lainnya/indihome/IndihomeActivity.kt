package com.citiasia.inidesakubeta.ui.ppob.lainnya.indihome
...
import com.citiasia.inidesakubeta.databinding.ActivityIndihomeBinding
...
class IndihomeActivity : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityIndihomeBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityIndihomeBinding.inflate(layoutInflater)
